...
echo -e "${CYAN}"
echo "################################################################"
echo "#   Start downloading and installing  spinner-selector_3.3     #"
echo "################################################################"
echo -e "${NC}"

IPK_URL="https://raw.githubusercontent.com/Ham-ahmed/705/refs/heads/main/enigma2-plugin-extensions-spinner-selector_3.3_all.ipk"
IPK_NAME="enigma2-plugin-extensions-spinner-selector_3.3_all.ipk"
