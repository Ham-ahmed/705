...
echo -e "${CYAN}"
echo "################################################################"
echo "#        Start downloading and installing estalker_1.38        #"
echo "################################################################"
echo -e "${NC}"

IPK_URL="https://raw.githubusercontent.com/Ham-ahmed/705/refs/heads/main/enigma2-plugin-extensions-estalker_1.38.20260429_all.ipk"
IPK_NAME="enigma2-plugin-extensions-estalker_1.38.20260429_all.ipk"
