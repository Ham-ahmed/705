...
echo -e "${CYAN}"
echo "################################################################"
echo "#        Start downloading and installing xstreamity_5.44      #"
echo "################################################################"
echo -e "${NC}"

IPK_URL="https://raw.githubusercontent.com/Ham-ahmed/705/refs/heads/main/enigma2-plugin-extensions-xstreamity_5.44.20260429_all.ipk"
IPK_NAME="enigma2-plugin-extensions-xstreamity_5.44.20260429_all.ipk"
